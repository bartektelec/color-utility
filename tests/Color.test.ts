  ...
  describe('Can convert values', () => {
    ...
    it('from RGB', () => {
      colors.forEach(colorObject => {
        ...
        expect(color.hexa).toEqual(colorObject.hex + 'ff');
        expect(color.hsl).toEqual(colorObject.hsl);
        expect(color.hsla).toEqual([...colorObject.hsl, 1]);
        // TODO expect HSB
        // expect(color.hsb).toEqual(colorObject.hsb);
        // expect(color.hsba).toEqual([...colorObject.hsb, 1]);
      });
    });
    it('from HEX', () => {
      // TODO expect RGB
